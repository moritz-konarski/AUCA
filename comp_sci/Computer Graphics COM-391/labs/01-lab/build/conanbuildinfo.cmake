...
set(CONAN_SDL2_ROOT "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035")
set(CONAN_INCLUDE_DIRS_SDL2 "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/include"
			"C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/include/SDL2")
set(CONAN_LIB_DIRS_SDL2 "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/lib")
set(CONAN_BIN_DIRS_SDL2 )
set(CONAN_RES_DIRS_SDL2 )
set(CONAN_SRC_DIRS_SDL2 )
set(CONAN_BUILD_DIRS_SDL2 "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/")
...
set(CONAN_GLEW_ROOT "C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7")
set(CONAN_INCLUDE_DIRS_GLEW "C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/include")
set(CONAN_LIB_DIRS_GLEW "C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/lib")
set(CONAN_BIN_DIRS_GLEW )
set(CONAN_RES_DIRS_GLEW )
set(CONAN_SRC_DIRS_GLEW )
set(CONAN_BUILD_DIRS_GLEW "C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/")
set(CONAN_FRAMEWORK_DIRS_GLEW )
set(CONAN_LIBS_GLEW libglew32 OpenGL32.lib)
set(CONAN_PKG_LIBS_GLEW libglew32 OpenGL32.lib)
...
# Aggregate package libs and frameworks for conan_package_library_targets()
set(CONAN_LIBS_FRAMEWORKS_GLEW ${CONAN_PKG_LIBS_GLEW} ${CONAN_FRAMEWORKS_FOUND_GLEW})
...
set(CONAN_DEPENDENCIES sdl2 glew)
...
set(CONAN_INCLUDE_DIRS "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/include"
			"C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/include/SDL2"
			"C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/lib"
			"C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_FRAMEWORK_DIRS  ${CONAN_FRAMEWORK_DIRS})
set(CONAN_LIBS SDL2main SDL2 libglew32 OpenGL32.lib ${CONAN_LIBS})
set(CONAN_PKG_LIBS SDL2main SDL2 libglew32 OpenGL32.lib ${CONAN_PKG_LIBS})
...
set(CONAN_CMAKE_MODULE_PATH "C:/Users/morit/.conan/data/sdl2/2.0.10/bincrafters/stable/package/576a51ffe34b47902449650e60ab345aecac2035/"
			"C:/Users/morit/.conan/data/glew/2.1.0/bincrafters/stable/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_GLEW}" "${CONAN_LIB_DIRS_GLEW}"
                                  CONAN_PACKAGE_TARGETS_GLEW "${CONAN_SYSTEM_LIBS_GLEW} "
                                  "" glew)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_GLEW_DEBUG}" "${CONAN_LIB_DIRS_GLEW_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_GLEW_DEBUG "${CONAN_SYSTEM_LIBS_GLEW_DEBUG} "
                                  "debug" glew)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_GLEW_RELEASE}" "${CONAN_LIB_DIRS_GLEW_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_GLEW_RELEASE "${CONAN_SYSTEM_LIBS_GLEW_RELEASE} "
                                  "release" glew)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_GLEW_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_GLEW_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_GLEW_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_GLEW_RELWITHDEBINFO} "
                                  "relwithdebinfo" glew)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_GLEW_MINSIZEREL}" "${CONAN_LIB_DIRS_GLEW_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_GLEW_MINSIZEREL "${CONAN_SYSTEM_LIBS_GLEW_MINSIZEREL} "
                                  "minsizerel" glew)

    add_library(CONAN_PKG::glew INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::glew PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_GLEW} ${CONAN_SHARED_LINKER_FLAGS_GLEW_LIST} ${CONAN_EXE_LINKER_FLAGS_GLEW_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_GLEW_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_GLEW_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_GLEW_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_GLEW_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_GLEW_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_GLEW_RELWITHDEBINFO_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_GLEW_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_GLEW_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_GLEW_MINSIZEREL_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_GLEW_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_GLEW_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_GLEW_DEBUG_LIST}>
                                                                 )
    ...
    set(CONAN_TARGETS CONAN_PKG::sdl2 CONAN_PKG::glew)
