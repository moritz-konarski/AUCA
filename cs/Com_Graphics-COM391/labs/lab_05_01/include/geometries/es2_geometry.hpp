...
namespace aur {
    ...
    public:
        explicit ES2Geometry(std::vector<unsigned int> &indices,
        ...
        void update(const Material &material) final {
            ...
            int position_attribute_location{
                    material.get_shader()->get_attributes().at("position")};
            ...
            int color_attribute_location{
                    material.get_shader()->get_attributes().at("color")};
            ...
            int texture_coordinates_attribute_location{
                    material.get_shader()->get_attributes().at(
                            "texture_coordinates")};
